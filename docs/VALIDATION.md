...
| Production dependency license policy | PASS — 80 records checked |
...
- Pinned GLiNER PII Small model downloaded, hash-verified, and cached locally.
...
- Production executable launched directly and remained responsive with the expected title.
